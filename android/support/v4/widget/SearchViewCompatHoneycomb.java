...
class SearchViewCompatHoneycomb {
    ...
    static class C01281 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01281(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01292 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01292(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
