...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
            ...
            private void onMediaButtonEvent(KeyEvent ke, Callback cb) {
                ...
                if (ke != null && ke.getAction() == 0) {
                    ...
                    switch (ke.getKeyCode()) {
                        case C0211R.styleable.AppCompatTheme_panelMenuListWidth /*79*/:
                        case C0211R.styleable.AppCompatTheme_colorControlNormal /*85*/:
                            boolean isPlaying;
                        ...
                        case C0211R.styleable.AppCompatTheme_colorControlHighlight /*87*/:
                            if ((32 & validActions) != 0) {
                                cb.onSkipToNext();
                            }
                        case C0211R.styleable.AppCompatTheme_colorButtonNormal /*88*/:
                            if ((16 & validActions) != 0) {
                                cb.onSkipToPrevious();
                            }
                        case C0211R.styleable.AppCompatTheme_colorSwitchThumbNormal /*89*/:
                            if ((8 & validActions) != 0) {
                                cb.onRewind();
                            }
        ...
        class C02941 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02941() {
            }
        ...
        class C03402 implements Callback {
            C03402() {
            }
        ...
        public MediaSessionImplBase(Context context, String tag, ComponentName mbrComponent, PendingIntent mbr) {
            ...
            this.mVolumeCallback = new C02941();
