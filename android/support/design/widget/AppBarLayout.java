...
public class AppBarLayout extends LinearLayout {
    ...
    class C02561 implements OnApplyWindowInsetsListener {
        C02561() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        protected static class SavedState extends BaseSavedState {
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C02581());
            }
        }

        /* renamed from: android.support.design.widget.AppBarLayout.Behavior.1 */
        class C02571 implements AnimatorUpdateListener {
            final /* synthetic */ AppBarLayout val$child;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;

            C02571(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset) {
            ...
            if (currentOffset != offset) {
                if (this.mAnimator == null) {
                    ...
                    this.mAnimator.setUpdateListener(new C02571(coordinatorLayout, child));
                } else {
                    this.mAnimator.cancel();
                }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02561());
    }
