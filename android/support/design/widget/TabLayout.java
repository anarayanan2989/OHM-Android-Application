...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        class C02761 implements AnimatorUpdateListener {
            ...
            C02761(int i, int i2, int i3, int i4) {
        ...
        class C03372 extends AnimatorListenerAdapter {
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setUpdateListener(new C02761(startLeft, targetLeft, startRight, targetRight));
                animator.setListener(new C03372(position));
                animator.start();
            }
        }
    ...
    class C02751 implements AnimatorUpdateListener {
        C02751() {
        }
        ...
        if (newPosition != INVALID_WIDTH) {
            ...
            if (startScrollX != targetScrollX) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.setUpdateListener(new C02751());
                }
