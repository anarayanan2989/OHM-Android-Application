...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C02611 implements OnApplyWindowInsetsListener {
        C02611() {
        }
    ...
    class C02622 implements AnimatorUpdateListener {
        C02622() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02611());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.setUpdateListener(new C02622());
