...
public class AsyncListUtil<T> {
    ...
    class C03151 implements MainThreadCallback<T> {
        C03151() {
        }
    ...
    class C03162 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C03151();
        this.mBackgroundCallback = new C03162();
        this.mTClass = klass;
