...
class AppCompatViewInflater {
    ...
    public final View createView(View parent, String name, @NonNull Context context, @NonNull AttributeSet attrs, boolean inheritContext, boolean readAndroidTheme, boolean readAppTheme, boolean wrapContext) {
        ...
        switch (obj) {
            ...
            case C0211R.styleable.Toolbar_titleTextAppearance /*10*/:
                ...
                break;
            case C0211R.styleable.Toolbar_subtitleTextAppearance /*11*/:
                view = new AppCompatRatingBar(context, attrs);
                break;
            case C0211R.styleable.Toolbar_titleMargins /*12*/:
    ...
    private static Context themifyContext(Context context, AttributeSet attrs, boolean useAndroidTheme, boolean useAppTheme) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0157R.styleable.View, 0, 0);
        int themeId = 0;
        if (useAndroidTheme) {
            themeId = a.getResourceId(C0157R.styleable.View_android_theme, 0);
        }
        if (useAppTheme && themeId == 0) {
            themeId = a.getResourceId(C0157R.styleable.View_theme, 0);
            if (themeId != 0) {
