...
class AppCompatTextHelper {
    ...
    static {
        ...
        TEXT_APPEARANCE_ATTRS = new int[]{C0157R.attr.textAllCaps};
    }
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (!(this.mView.getTransformationMethod() instanceof PasswordTransformationMethod)) {
            ...
            if (ap != -1) {
                TypedArray appearance = context.obtainStyledAttributes(ap, C0157R.styleable.TextAppearance);
                if (appearance.hasValue(C0157R.styleable.TextAppearance_textAllCaps)) {
                    allCapsSet = true;
                    allCaps = appearance.getBoolean(C0157R.styleable.TextAppearance_textAllCaps, false);
                }
                appearance.recycle();
            }
