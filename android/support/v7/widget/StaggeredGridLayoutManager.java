...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            static class C02001 implements Creator<FullSpanItem> {
                C02001() {
                }
    ...
    class C03542 extends LinearSmoothScroller {
        C03542(Context x0) {
            super(x0);
        }
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mCheckForGapsRunnable = new C01991();
    ...
    public void smoothScrollToPosition(RecyclerView recyclerView, State state, int position) {
        LinearSmoothScroller scroller = new C03542(recyclerView.getContext());
