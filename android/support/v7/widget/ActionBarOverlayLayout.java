...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    static {
        ATTRS = new int[]{C0157R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03471();
        this.mRemoveActionBarHideOffset = new C01632();
        this.mAddActionBarHideOffset = new C01643();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0157R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0157R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0157R.id.action_bar));
        }
    }
