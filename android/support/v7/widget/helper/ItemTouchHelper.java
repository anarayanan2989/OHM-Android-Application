...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class C02084 implements Runnable {
        ...
        C02084(RecoverAnimation recoverAnimation, int i) {
    ...
    public static abstract class Callback {
        ...
        static class C02091 implements Interpolator {
            C02091() {
            }
        ...
        static class C02102 implements Interpolator {
            C02102() {
            }
        ...
        static {
            sDragScrollInterpolator = new C02091();
            sDragViewScrollCapInterpolator = new C02102();
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == ItemTouchHelper.ACTIVE_POINTER_ID_NONE) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0158R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    class C03322 implements OnItemTouchListener {
        C03322() {
        }
    ...
    class C03335 implements ChildDrawingOrderCallback {
        C03335() {
        }
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        class C03341 implements AnimatorUpdateListenerCompat {
            final /* synthetic */ ItemTouchHelper val$this$0;

            C03341(ItemTouchHelper itemTouchHelper) {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C03341(ItemTouchHelper.this));
    ...
    class C03563 extends RecoverAnimation {
        final /* synthetic */ ViewHolder val$prevSelected;
        final /* synthetic */ int val$swipeDir;

        C03563(ViewHolder x0, int x1, int x2, float x3, float x4, float x5, float x6, int i, ViewHolder viewHolder) {
            this.val$swipeDir = i;
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0158R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0158R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
        ...
        if (selected != this.mSelected || actionState != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    RecoverAnimation rv = new C03563(prevSelected, animationType, prevActionState, currentTranslateX, currentTranslateY, targetTranslateX, targetTranslateY, swipeDir, prevSelected);
    ...
    private void postDispatchSwipe(RecoverAnimation anim, int swipeDir) {
        this.mRecyclerView.post(new C02084(anim, swipeDir));
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C03335();
            }
