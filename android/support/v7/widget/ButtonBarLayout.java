...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, C0157R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0157R.styleable.ButtonBarLayout_allowStacking, false);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0157R.id.spacer);
        if (spacer != null) {
